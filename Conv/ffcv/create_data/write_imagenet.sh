...
# Set environment variables for ImageNet directory and output directory
export IMAGENET_DIR=/datadrive/hengl/imagenet1k/ILSVRC/Data/CLS-LOC/
export WRITE_DIR=/datadrive2/hengl/imagenet1k_ffcv
